...
columnas <- c("hombres","mujeres","suma hombres y mujeres","general","coinciden")

## data frames validaciones
validacion_fuente <- data.frame(suma_fuente_mas, suma_fuente_fem, suma_fuente_masfem, suma_fuente_gen, verd_fuente, row.names = Fuente)
colnames(validacion_fuente) <- columnas

validacion_mes <- data.frame(suma_mes_mas, suma_mes_fem, suma_mes_masfem, suma_mes_gen, verd_mes, row.names = Mes)
colnames(validacion_mes) <- columnas
validacion_grupo <- data.frame(suma_grupo_mas, suma_grupo_fem, suma_grupo_masfem, suma_grupo_gen, verd_grupo, row.names = Grupo)
